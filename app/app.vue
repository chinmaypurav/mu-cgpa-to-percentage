  ...
  <div class="cover-stock min-h-screen text-paper-50">
    ...
    <footer class="no-print border-t border-ink-800/70">
      <div class="mx-auto max-w-5xl px-5 py-6 sm:px-8">
        <p class="font-mono text-[10px] leading-relaxed tracking-[0.08em] text-ink-500">
          Conversion per University of Mumbai Circular No. 1883 of 2017 · Percentage = 7.1 × CGPA + 11 ·
          overall CGPA is the mean of the entered semester CGPAs. Unofficial worksheet — verify against your transcript.
        </p>
      </div>
    </footer>
  </div>
